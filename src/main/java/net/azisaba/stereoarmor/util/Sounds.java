 ...
 */
public class Sounds {
    private Sounds() {} // don't let anyone create instance of this

    @NotNull public static final List<String> sounds = Stream.of(Sound.values()).map(Enum::name).collect(Collectors.toCollection(ArrayList::new));
    @NotNull public static final Map<String, Sound> knownSounds = new HashMap<>();
     ...
     * Wood + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_BASS;

    /**
     * Stone + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_BASEDRUM;

    /**
     * Wool + Note Block
     * <p>Missing on 1.9 - 1.11.2
     */
    @Nullable public static final Sound BLOCK_NOTE_BASS_GUITAR;

    /**
     * Sand + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_SNARE_DRUM;

    /**
     * Dirt, air, grass + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_HARP;

    /**
     * Glowstone Block + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_PLING;

    /**
     * Glass Block + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_HAT;

    /**
     * Soul Sand + Note Block
     * <p>Available on 1.14+
     */
    @Nullable public static final Sound BLOCK_NOTE_COW_BELL;

    /**
     * Pumpkin + Note Block
     * <p>Available on 1.14+
     */
    @Nullable public static final Sound BLOCK_NOTE_DIDGERIDOO;

    /**
     * Emerald Block + Note Block
     * <p>Available on 1.14+
     */
    @Nullable public static final Sound BLOCK_NOTE_BIT;

    /**
     * Hay Block + Note Block
     * <p>Available on 1.14+
     */
    @Nullable public static final Sound BLOCK_NOTE_BANJO;

    /**
     * Bone Block + Note Block
     * <p>Available on 1.12+
     */
    @Nullable public static final Sound BLOCK_NOTE_XYLOPHONE;

    /**
     * Iron Block + Note Block
     * <p>Available on 1.12+
     */
    @Nullable public static final Sound BLOCK_NOTE_IRON_XYLOPHONE;

    /**
     * Packed Ice Block + Note Block
     * <p>Available on 1.12+
     */
    @Nullable public static final Sound BLOCK_NOTE_CHIME;

    /**
     * Gold Block + Note Block
     * <p>Available on 1.12+
     */
    @Nullable public static final Sound BLOCK_NOTE_BELL;

    /**
     * Clay Block + Note Block
     * <p>Available on 1.12+
     */
    @Nullable public static final Sound BLOCK_NOTE_FLUTE;

    // =============== Entities =============== //

    // ----- TNT ----- //

    @NotNull public static final Sound ENTITY_TNT_PRIMED;

    // ----- Experience Orb ----- //

    @NotNull public static final Sound ENTITY_EXPERIENCE_ORB_PICKUP;
     ...
     * Glass Block + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_STICKS;

    /**
     * Stone + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_BASS_DRUM;

    /**
     * Sand + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_SNARE;

    /**
     * Dirt, air, grass + Note Block
     */
    @NotNull public static final Sound BLOCK_NOTE_PIANO;
    ...
    @Contract("_, _ -> param1")
    @NotNull
    private static Sound registerMapping(@NotNull Sound sound, @NotNull String @NotNull... s) {
        for (String name : s) knownSounds.put(name.toUpperCase(Locale.ROOT), sound);
        return sound;
    }
     ...
     * </ul>
     * This method throws IllegalArgumentException, rather than returning null if unable to find fallback when required.
    ...
    public static Sound getSound(@Nullable String fallback, @NotNull String @NotNull... sounds) throws IllegalArgumentException {
        Sound result = null;
        for (String sound : sounds) {
            if (Sounds.sounds.contains(sound.toUpperCase(Locale.ROOT))) {
                result = Sound.valueOf(sound.toUpperCase(Locale.ROOT));
                break;
            }
        }
        if (result == null && fallback != null) {
            result = Sound.valueOf(fallback.toUpperCase(Locale.ROOT));
        }
        if (result != null) {
            for (String sound : sounds) knownSounds.put(sound, result);
            if (fallback != null) knownSounds.put(fallback, result);
        }
        return result;
    }
     ...
     * </ul>
     * This method returns null if unable to find fallback when required.
     * @deprecated Use {@link #tryResolveSound(String)} unless you have specific reason to use this method
     * @param fallback the fallback sound id when couldn't find sound from sounds list.
     * @param sounds sounds list to find.
     * @return the sound
    ...
    @Deprecated
    @Nullable
    public static Sound getSoundNullable(@Nullable String fallback, @NotNull String @NotNull... sounds) throws IllegalArgumentException {
        Sound result = null;
        for (String sound : sounds) {
            if (Sounds.sounds.contains(sound.toUpperCase(Locale.ROOT))) {
                result = Sound.valueOf(sound.toUpperCase(Locale.ROOT));
        ...
        if (result == null && fallback != null && Sounds.sounds.contains(fallback.toUpperCase(Locale.ROOT))) {
            result = Sound.valueOf(fallback.toUpperCase(Locale.ROOT));
        }
        if (result != null) {
            for (String sound : sounds) knownSounds.put(sound, result);
     ...
     */
    @Nullable
    public static Sound tryResolveSound(@NotNull String sound) {
        String up = sound.toUpperCase().replaceAll("\\.", "_");
        if (knownSounds.containsKey(up)) return knownSounds.get(up);
        return Stream.of(Sound.values()).filter(s -> s.name().toUpperCase().equals(up)).findFirst().orElse(null);
    }
}
